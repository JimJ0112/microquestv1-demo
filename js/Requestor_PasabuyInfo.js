...
//get service ratings
function getServiceRatings(userID){
    var userID = userID;
    var number = number;
    ...
    xmlhttp.open("POST", "Backend/AveragePasabuyStars.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttp.send(query);
...
function setServicesData(dataArray){
   ...
   // getServiceRatings(dataArray[0]['serviceID']);
    getServiceRatings(dataArray[0]['responderID']);
    getServiceReviews(dataArray[0]['responderID']);
...
function getServiceReviews(userID){
    var userID = userID;
    var query = "revieweeID=" + userID;
    var xmlhttp = new XMLHttpRequest();
  
    xmlhttp.open("POST", "Backend/Get_pasabuyRatingsandFeedbacks.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
