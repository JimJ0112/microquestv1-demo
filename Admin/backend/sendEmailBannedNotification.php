            ...
            <tr>
                <td bgcolor='#fffff' align='center' style='padding: 20px 30px 60px 30px;'>
                    <table border='0' cellspacing='0' cellpadding='0'>
                        <tr>
                            <td align='center' style='border-radius: 3px; margin: auto; width: 50%;' bgcolor='#FFA73B'><p style='font-size: 40px; font-family: Helvetica, Arial, sans-serif; color: black; text-decoration: none; color: #6c472c; text-decoration: none; padding: 10px 25px; border-radius: 2px; border: 1px solid #FFA73B; display: inline-block;'> 
                               hello $recipient, We're sorry to inform you that your Microquest Account has been banned, to file an appeal, email us at microquestteam@gmail.com. thank you for your time
                            </td>
                            </tr>
...
echo "<script>window.location.assign('../BannedUsers.php')</script>";
