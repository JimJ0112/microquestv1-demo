...
$query = "SELECT reportedAccountID,reportCategory,reportDescription,reportedServiceID,reportedRequestID,reportActionDate,reportStatus,restrictDuration FROM reportsinfo WHERE reportStatus = 'Restricted';";
